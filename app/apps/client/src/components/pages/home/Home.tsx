...
const Home: FC = () => {
   ...
   return (
      <div className={styles.wrapper}>
         ...
         <section>
            <Link to="/">«Пушкинская карта» в Парке</Link>
            <Link to="/">Музей истории Парка</Link>
            <Link to="/">Ботанический сад</Link>
            <Link to="/">Пешеходные экскурсии</Link>
            <Link to="/">Объекты Парка</Link>
            <Link to="/">Карта Парка</Link>
         </section>
      </div>
   );
};
